...
def predict_rolling_sequence(game_context: Dict[str, Any], n_iterations: int = 5, skip_stage1: bool = False) -> Dict[str, Any]:
    ...
    if skip_stage1:
        ...
        try:
            ...
            stage1_content, stage1_usage = client.predict_with_validation(
    ...
    try:
        for iteration in range(n_iterations):
            ...
            stage2_content, stage2_usage = client.predict_with_validation(
...
def main():
    ...
    if TEST_MODE == "full_pipeline":
        ...
        import json
        json_data = """{\"away_team\":{\"name\":\"WAS\",\"stats\":{\"OEFF\":113.0,\"DEFF\":121.4,\"PACE\":102.6,\"REST_DAYS\":2},\"players\":[{\"name\":\"Deni Avdija\",\"profile\":{\"offense\":1.81,\"defense\":1.18,\"shot_selection\":0.8,\"efficiency\":-0.97,\"MPG\":27,\"usage\":19}},{\"name\":\"Kyle Kuzma\",\"profile\":{\"offense\":3.32,\"defense\":0.53,\"shot_selection\":-0.1,\"efficiency\":-0.88,\"MPG\":31,\"usage\":31}},{\"name\":\"Daniel Gafford\",\"profile\":{\"offense\":0.67,\"defense\":4.07,\"shot_selection\":2.07,\"efficiency\":-2.08,\"MPG\":26,\"usage\":14}},{\"name\":\"Jordan Poole\",\"profile\":{\"offense\":2.13,\"defense\":1.75,\"shot_selection\":-0.12,\"efficiency\":-0.36,\"MPG\":29,\"usage\":26}},{\"name\":\"Tyus Jones\",\"profile\":{\"offense\":1.76,\"defense\":0.21,\"shot_selection\":-0.68,\"efficiency\":-0.59,\"MPG\":29,\"usage\":17}},{\"name\":\"Corey Kispert\",\"profile\":{\"offense\":0.51,\"defense\":-0.61,\"shot_selection\":-0.68,\"efficiency\":-0.96,\"MPG\":22,\"usage\":20}},{\"name\":\"Bilal Coulibaly\",\"profile\":{\"offense\":0.49,\"defense\":1.43,\"shot_selection\":0.25,\"efficiency\":-0.58,\"MPG\":26,\"usage\":14}},{\"name\":\"Marvin Bagley III\",\"profile\":{\"offense\":0.43,\"defense\":0.1,\"shot_selection\":1.94,\"efficiency\":-1.1,\"MPG\":20,\"usage\":21}},{\"name\":\"Landry Shamet\",\"profile\":{\"offense\":-0.35,\"defense\":-0.08,\"shot_selection\":-0.57,\"efficiency\":-0.31,\"MPG\":15,\"usage\":21}},{\"name\":\"Delon Wright\",\"profile\":{\"offense\":-0.51,\"defense\":0.18,\"shot_selection\":0.51,\"efficiency\":0.91,\"MPG\":16,\"usage\":14}}]},\"home_team\":{\"name\":\"SAS\",\"stats\":{\"OEFF\":112.0,\"DEFF\":120.5,\"PACE\":101.4,\"REST_DAYS\":2},\"players\":[{\"name\":\"Julian Champagnie\",\"profile\":{\"offense\":-0.42,\"defense\":-0.16,\"shot_selection\":-1.11,\"efficiency\":-0.47,\"MPG\":16,\"usage\":15}},{\"name\":\"Jeremy Sochan\",\"profile\":{\"offense\":1.68,\"defense\":0.89,\"shot_selection\":0.31,\"efficiency\":-0.3,\"MPG\":29,\"usage\":18}},{\"name\":\"Victor Wembanyama\",\"profile\":{\"offense\":3.1,\"defense\":4.84,\"shot_selection\":0.65,\"efficiency\":-1.07,\"MPG\":29,\"usage\":32}},{\"name\":\"Devin Vassell\",\"profile\":{\"offense\":1.79,\"defense\":0.26,\"shot_selection\":-0.25,\"efficiency\":-0.65,\"MPG\":31,\"usage\":23}},{\"name\":\"Tre Jones\",\"profile\":{\"offense\":1.66,\"defense\":0.02,\"shot_selection\":0.22,\"efficiency\":-0.61,\"MPG\":25,\"usage\":16}},{\"name\":\"Dominick Barlow\",\"profile\":{\"offense\":-1.03,\"defense\":-0.07,\"shot_selection\":1.49,\"efficiency\":0.52,\"MPG\":13,\"usage\":14}},{\"name\":\"Keldon Johnson\",\"profile\":{\"offense\":1.78,\"defense\":1.0,\"shot_selection\":0.28,\"efficiency\":-0.49,\"MPG\":31,\"usage\":23}},{\"name\":\"Cedi Osman\",\"profile\":{\"offense\":-0.04,\"defense\":-0.4,\"shot_selection\":-0.68,\"efficiency\":-0.72,\"MPG\":18,\"usage\":16}},{\"name\":\"Blake Wesley\",\"profile\":{\"offense\":-0.62,\"defense\":-0.43,\"shot_selection\":1.06,\"efficiency\":0.3,\"MPG\":12,\"usage\":15}},{\"name\":\"Doug McDermott\",\"profile\":{\"offense\":-0.31,\"defense\":-1.24,\"shot_selection\":-1.99,\"efficiency\":-1.05,\"MPG\":15,\"usage\":14}}]},\"recent_plays\":[{\"quarter\":2,\"time_remaining\":\"00:00\",\"score\":\"WAS 54 - SAS 58\",\"players_on_court\":[{\"team\":\"WAS\",\"players\":[\"Marvin Bagley III\",\"Tyus Jones\",\"Bilal Coulibaly\",\"Kyle Kuzma\",\"Jordan Poole\"]},{\"team\":\"SAS\",\"players\":[\"Devin Vassell\",\"Julian Champagnie\",\"Cedi Osman\",\"Dominick Barlow\",\"Jeremy Sochan\"]}],\"player\":\"Kyle Kuzma\",\"description\":\"Kuzma 17' Turnaround Jump Shot\",\"shot_details\":{\"team\":\"WAS\",\"points\":2,\"x_coord\":32.7,\"y_coord\":20.2}},{\"quarter\":3,\"time_remaining\":\"11:36\",\"score\":\"WAS 54 - SAS 58\",\"players_on_court\":[{\"team\":\"WAS\",\"players\":[\"Daniel Gafford\",\"Kyle Kuzma\",\"Deni Avdija\",\"Jordan Poole\",\"Tyus Jones\"]},{\"team\":\"SAS\",\"players\":[\"Victor Wembanyama\",\"Julian Champagnie\",\"Devin Vassell\",\"Tre Jones\",\"Jeremy Sochan\"]}],\"player\":\"Victor Wembanyama\",\"description\":\"MISS Wembanyama 2' Driving Layup\",\"shot_details\":{\"team\":\"SAS\",\"points\":0,\"x_coord\":26.8,\"y_coord\":41.9}},{\"quarter\":3,\"time_remaining\":\"11:34\",\"score\":\"WAS 54 - SAS 58\",\"players_on_court\":[{\"team\":\"WAS\",\"players\":[\"Daniel Gafford\",\"Kyle Kuzma\",\"Deni Avdija\",\"Jordan Poole\",\"Tyus Jones\"]},{\"team\":\"SAS\",\"players\":[\"Victor Wembanyama\",\"Julian Champagnie\",\"Devin Vassell\",\"Tre Jones\",\"Jeremy Sochan\"]}],\"player\":\"Daniel Gafford\",\"description\":\"GAFFORD DEF.REBOUND\",\"shot_details\":{\"team\":null,\"points\":null,\"x_coord\":null,\"y_coord\":null}},{\"quarter\":3,\"time_remaining\":\"11:20\",\"score\":\"WAS 54 - SAS 58\",\"players_on_court\":[{\"team\":\"WAS\",\"players\":[\"Daniel Gafford\",\"Kyle Kuzma\",\"Deni Avdija\",\"Jordan Poole\",\"Tyus Jones\"]},{\"team\":\"SAS\",\"players\":[\"Victor Wembanyama\",\"Julian Champagnie\",\"Devin Vassell\",\"Tre Jones\",\"Jeremy Sochan\"]}],\"player\":\"Victor Wembanyama\",\"description\":\"Wembanyama S.FOUL on Daniel Gafford\",\"shot_details\":{\"team\":null,\"points\":null,\"x_coord\":null,\"y_coord\":null}},{\"quarter\":3,\"time_remaining\":\"11:20\",\"score\":\"WAS 55 - SAS 58\",\"players_on_court\":[{\"team\":\"WAS\",\"players\":[\"Daniel Gafford\",\"Kyle Kuzma\",\"Deni Avdija\",\"Jordan Poole\",\"Tyus Jones\"]},{\"team\":\"SAS\",\"players\":[\"Victor Wembanyama\",\"Julian Champagnie\",\"Devin Vassell\",\"Tre Jones\",\"Jeremy Sochan\"]}],\"player\":\"Daniel Gafford\",\"description\":\"Gafford Free Throw 1 of 2\",\"shot_details\":{\"team\":null,\"points\":null,\"x_coord\":null,\"y_coord\":null}},{\"quarter\":3,\"time_remaining\":\"11:20\",\"score\":\"WAS 55 - SAS 58\",\"players_on_court\":[{\"team\":\"WAS\",\"players\":[\"Daniel Gafford\",\"Kyle Kuzma\",\"Deni Avdija\",\"Jordan Poole\",\"Tyus Jones\"]},{\"team\":\"SAS\",\"players\":[\"Victor Wembanyama\",\"Julian Champagnie\",\"Devin Vassell\",\"Tre Jones\",\"Jeremy Sochan\"]}],\"player\":\"Daniel Gafford\",\"description\":\"MISS Gafford Free Throw 2 of 2\",\"shot_details\":{\"team\":null,\"points\":null,\"x_coord\":null,\"y_coord\":null}},{\"quarter\":3,\"time_remaining\":\"11:17\",\"score\":\"WAS 55 - SAS 58\",\"players_on_court\":[{\"team\":\"WAS\",\"players\":[\"Daniel Gafford\",\"Kyle Kuzma\",\"Deni Avdija\",\"Jordan Poole\",\"Tyus Jones\"]},{\"team\":\"SAS\",\"players\":[\"Victor Wembanyama\",\"Julian Champagnie\",\"Devin Vassell\",\"Tre Jones\",\"Jeremy Sochan\"]}],\"player\":\"Victor Wembanyama\",\"description\":\"WEMBANYAMA DEF.REBOUND\",\"shot_details\":{\"team\":null,\"points\":null,\"x_coord\":null,\"y_coord\":null}},{\"quarter\":3,\"time_remaining\":\"11:09\",\"score\":\"WAS 55 - SAS 61\",\"players_on_court\":[{\"team\":\"WAS\",\"players\":[\"Daniel Gafford\",\"Kyle Kuzma\",\"Deni Avdija\",\"Jordan Poole\",\"Tyus Jones\"]},{\"team\":\"SAS\",\"players\":[\"Victor Wembanyama\",\"Julian Champagnie\",\"Devin Vassell\",\"Tre Jones\",\"Jeremy Sochan\"]}],\"player\":\"Julian Champagnie\",\"description\":\"Champagnie 3PT Jump Shot\",\"shot_details\":{\"team\":\"SAS\",\"points\":3,\"x_coord\":1.7,\"y_coord\":42.5}},{\"quarter\":3,\"time_remaining\":\"11:09\",\"score\":\"WAS 55 - SAS 61\",\"players_on_court\":[{\"team\":\"WAS\",\"players\":[\"Daniel Gafford\",\"Kyle Kuzma\",\"Deni Avdija\",\"Jordan Poole\",\"Tyus Jones\"]},{\"team\":\"SAS\",\"players\":[\"Victor Wembanyama\",\"Julian Champagnie\",\"Devin Vassell\",\"Tre Jones\",\"Jeremy Sochan\"]}],\"player\":\"Kyle Kuzma\",\"description\":\"Kuzma S.FOUL on Julian Champagnie\",\"shot_details\":{\"team\":null,\"points\":null,\"x_coord\":null,\"y_coord\":null}},{\"quarter\":3,\"time_remaining\":\"11:09\",\"score\":\"WAS 55 - SAS 61\",\"players_on_court\":[{\"team\":\"WAS\",\"players\":[\"Daniel Gafford\",\"Kyle Kuzma\",\"Deni Avdija\",\"Jordan Poole\",\"Tyus Jones\"]},{\"team\":\"SAS\",\"players\":[\"Victor Wembanyama\",\"Julian Champagnie\",\"Devin Vassell\",\"Tre Jones\",\"Jeremy Sochan\"]}],\"player\":\"Julian Champagnie\",\"description\":\"MISS Champagnie Free Throw 1 of 1\",\"shot_details\":{\"team\":null,\"points\":null,\"x_coord\":null,\"y_coord\":null}}]}"""
    ...
    try:
        ...
        n_iterations = 325  # Change this to control how many rolling predictions
