    ...
    # CONFIGURATION
    SPREAD_CONFIDENCE_THRESHOLD = 0.80  # 70% of simulations must support the bet
    MIN_SIMULATIONS_REQUIRED = 7       # Minimum simulations needed for analysis
    ML_EDGE_THRESHOLD = 0.20             # 10% minimum edge over implied odds for ML bets
