...
For Each Play:
  ├── Build Game Context
  │   ├── Team Stats (OEFF, DEFF, PACE, 3PAr, FTr, ORr, ASTr, REST)
...
- Per-100 possession rates (ast/100, stl/100, blk/100)
- Usage and minutes
- Player archetype cluster (K=25 clustering)

### Team Statistics

Teams have 8-value stat arrays:
...
4. **3PAr**: 3-point attempt rate
5. **FTr**: Free throw rate
6. **ORr**: Offensive rebound rate
7. **ASTr**: Assist rate
8. **REST**: Rest days before game
