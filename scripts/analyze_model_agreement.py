"""
Analyze agreement between old and new models on 24-25 season.
...
print("2024-25 Season (1,315 games)")
print("="*100)
print()

# Load predictions from both models
old_pred = pd.read_csv('predictions/test_2425_normalized_predictions_FRESH.csv')
new_pred = pd.read_csv('predictions/test_2425_NEW_MODEL_predictions.csv')
...
disagree_games_out.to_csv('predictions/model_disagreement_analysis_2425.csv', index=False)

print("="*100)
print("✅ Detailed disagreement games saved to: predictions/model_disagreement_analysis_2425.csv")
print("="*100)
print()
